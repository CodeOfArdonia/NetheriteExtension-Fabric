...
public enum NetheriteElytraArmorMaterials implements ArmorMaterial {
    NETHERITE_ELYTRA_MATERIAL("netherite_elytra", 37, new int[]{3,  NetheriteExtensionConfig.getInstance().damage.elytra_armor_points,4, 3}, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> Ingredient.ofItems(Items.NETHERITE_INGOT));
